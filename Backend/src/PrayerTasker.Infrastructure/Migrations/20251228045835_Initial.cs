        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAutoLocation = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "DailyUserPrayerTimes",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Fajr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Shurooq = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Dhuhr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyUserPrayerTimes", x => x.Id);
                    table.ForeignKey(
